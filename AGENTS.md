...
- Primary docs live in C:\\Dev\\_OpsVault\\Chestno.ru\\Docs.
- Session notes/logs must be written to C:\\Dev\\_OpsVault\\Chestno.ru\\Sessions.
- Secrets and .env files live in C:\\Dev\\_OpsVault\\Chestno.ru\\Secrets (never in repo).

    ...
    with get_connection() as conn, conn.cursor(row_factory=dict_row) as cur:
        cur.execute(
            ...
            SELECT o.id, o.name, o.slug, o.country, o.city, o.website_url, o.is_verified,
                   ...
                   p.safety_and_quality, p.video_url, p.gallery, NULL as category, NULL as founded_year,
                   NULL as employee_count, NULL as factory_size, NULL::jsonb as certifications, NULL as sustainability_practices,
                   NULL as quality_standards, NULL::jsonb as buy_links,
